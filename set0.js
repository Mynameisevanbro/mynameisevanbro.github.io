...
menospreciar
to underestimate/to despise (not despreciar)
...
vencer
to defeat/to overcome (not derrotar)
...
convertir
to convert/to turn into/to change
...
trascender
to emerge/to transcend (not surgir)



manejar
to handle/to drive (not conducir)
...
surgir
to arise/to emerge/to appear (not trascender)



destacar
to emphasize/to stand out (not sobresalir)



parquear
to park (not estacionar)
...
rodear
to surround/to go around/to encircle



hallar
to find/to discover/to locate/to feel/to be apart of
...
sobresalir
to emphasize/to stand out (not destacar)
...
fundar
to establish/to build/to found (as in to build)
...
expulsar
to expel/to throw out/to eject



partir
to part/to cut/to split/to set off



pisar
to step on/to set foot
...
derrotar
to defeat (not vencer)



suprimir
to suppress/to abolish/to delete
...
brindar
to make a toast (expression of honor or goodwill before drinking)



venerar
to venerate/to warship
...
exponer
to expose/to exhibit/to explain
...
redactar
to write (not escribir; to put in writing)
...
rebuscar
to search carefully (stronger version of buscar)
...
calificar
to grade/to describe as/to qualify
...
aperar
to harness/to provide/to equip
...
afligir
to afflict (harm)/to upset



enchufar
to plug in (electricity)/to join



alzar
to raise/to lift (not levantar)



recostar
to learn/to lay back
